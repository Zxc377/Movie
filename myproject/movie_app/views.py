...
from .serializers import (UserSerializer, CountrySerializer, CountryDetailSerializer,
                          ...
                          FavoriteSerializer, FavoriteMovieSerializer, HistorySerializer, ActorDetailSerializer,
                          GenreDetailSerializer, UserProfileRegisterSerializer, UserProfileLoginSerializer)
